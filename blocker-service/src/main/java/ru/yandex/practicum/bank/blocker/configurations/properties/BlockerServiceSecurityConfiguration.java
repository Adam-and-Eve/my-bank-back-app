...
/**
 * <summary>
 * Конфигурация безопасности (Spring Security) для микросервиса блокировок (Blocker Service).
...
@Configuration
@EnableWebSecurity
public class BlockerServiceSecurityConfiguration {
     ...
     * защищает POST-запрос проверки блокировок (/api/blocker/check) ролью SERVICE,
    ...
    /**
     * <summary>
     * Создает конвертер JWT-токенов, который отвечает за извлечение ролей сервиса
