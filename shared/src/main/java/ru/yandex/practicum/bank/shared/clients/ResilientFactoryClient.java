...
public class ResilientFactoryClient {
    ...
    public static ResilientFactoryClient withDefaults() {
    ...
    public ResilientExecutorClient create(String name) {
        return create(name, exception -> true);
    }

    public ResilientExecutorClient create(String name, Predicate<Throwable> recoverable) {
        ...
        return new ResilientExecutorClient(circuitBreaker, retry);
    }
