...
/**
 * <summary>
 * Конфигурация безопасности Spring Security для сервиса уведомлений (Notification Service).
...
public class NotificationSecurityConfiguration {
    ...
    /**
     * <summary>
     * Конфигурирует цепочку фильтров безопасности HTTP Security.
     * </summary>
    ...
    SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(requests -> requests
                        ...
                        .access(allOf(hasRole("SERVICE"), hasRole("NOTIFICATION_WRITE")))
                        .anyRequest().denyAll()
                )
    ...
    /**
     * <summary>
     * Записывает объект ошибки ApiErrorResponseViewModel в ответ HTTP в формате JSON с заданным кодом состояния.
     * </summary>
